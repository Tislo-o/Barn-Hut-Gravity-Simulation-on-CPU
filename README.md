...
-If GENERATE_PNGS = true, the program will generate pngs images of each frame in a "frames" folder located in the same folder as your .exe (make sure to create the "frames" folder beforehand otherwise the program will complain at execution)
